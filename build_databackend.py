...
def generate_multidatabackend_config(folder_path: str, job_id: str, output_dir: str = "config") -> str:
    ...
    config_list.append({
        ...
        "default": True,
        "type": "local",
        "cache_dir": "/mnt/data/om/SimpleTuner/cache/hidream/text",
    ...
    for res in resolutions:
        ...
        config_list.append({
            ...
            "cache_dir_vae": f"/mnt/data/om/SimpleTuner/cache/hidream/vae/{res}",
            "resolution": res,
        ...
        config_list.append({
            ...
            "metadata_backend": "discovery",
            "caption_strategy": "textfile",
            "cache_dir_vae": f"/mnt/data/om/SimpleTuner/cache/hidream/vae-crop/{res}",
            "resolution": res,
            "minimum_image_size": min_size,
            "repeats": 1
        })
