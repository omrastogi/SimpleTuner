...
# -------------------------------------------------------------------- #
try:
    from scripts.build_config.generate_databackend import generate_multidatabackend_config
    from scripts.build_config.generate_lycrosis_config import generate_lycrosis_config
...
def prerun(preconfig, save_to="configd") -> None:
    ...
    output_base_dir = cfg.get("output_base_dir", "output")
    job_id = cfg["job_id"]
